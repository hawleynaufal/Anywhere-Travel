        ...
        <section class="col-lg-12 connectedSortable">
          <div class="col-md-12">
            <div class="box">
              ...
              <form action="{{ route('costumer.index') }}" class="form-inline" method="get" >                
              ...
              <div class="box-body">
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td>
                      <form action="{{route('costumer.destroy',$costumers)}}" method="post">
                        {{csrf_field()}}
                        {{method_field('DELETE')}}
                        <button type="submit" class="btn btn-danger btn-xs">hapus</button>
                      </form>  
                      <a href="{{route('costumer.edit',$costumers)}}">
